...
# Admin
#--------------------------------------------------------------------------------
class WorkingDescriptionInlineAdmin(admin.StackedInline):
...
@admin.register(WorkingDescriptionProxy)
class WorkingDescriptionAdmin(admin.ModelAdmin):
    ...
    inlines = [WorkingDescriptionInlineAdmin]
    filter_horizontal = []
    radio_fields = {}
    def save_model(self, request, instance, form, change):
        user = request.user
        instance.type=instance.Types.WORKINGDESCRIPTION
