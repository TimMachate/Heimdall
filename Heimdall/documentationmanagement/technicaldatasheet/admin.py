...
# Admin
#--------------------------------------------------------------------------------
class TechnicalDataSheetInlineAdmin(admin.StackedInline):
...
@admin.register(TechnicalDataSheetProxy)
class TechnicalDataSheetAdmin(admin.ModelAdmin):
    ...
    inlines = [TechnicalDataSheetInlineAdmin]
    filter_horizontal = []
    radio_fields = {}
    def save_model(self, request, instance, form, change):
        user = request.user
        instance.type=instance.Types.TECHNICALDATASHEET
