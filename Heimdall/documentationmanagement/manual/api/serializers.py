...
class ManualListSerializer(FileListSerializer):
    ...
    def get_content(self,obj):
        return ManualSerializer(instance=obj.content(), many=False, read_only=True).data
...
class ManualDetailSerializer(FileDetailSerializer):
    content = serializers.SerializerMethodField()
