...
# Model
#--------------------------------------------------------------------------------
class Direction(ReferenceNumber,Slug):
    ...
    file_id = models.OneToOneField(
        ...
        related_name = 'direction_file_id',
    ...
    permissions = (
            ('detail_direction','Can view Detail Direction'),
            ('list_direction','Can view List Direction'),
            ('table_direction','Can view Table Direction')
        )
#--------------------------------------------------------------------------------