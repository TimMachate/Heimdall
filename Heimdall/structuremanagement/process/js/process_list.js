function process_list(api_data_url,model) {
            ...
            success: function(dataset){
                let col = [
                    ...
                    },
                    {
                        ...
                        "render":function(data,type,row,meta){return '<a class="link-dark" href="'+ row.url_detail +'">'+row.name+'</a>'}
                    },
                    {
                        "name":"duration_days",
                        "data":"duration_days",
                        ...
                        "width":"35px",
                        "className":"",
                        "visible": "duration" in dataset[0] ? true : false,
                        "render":function(data,type,row,meta){return row.duration.days}
                    },
                    {
                        "name":"duration_hours",
                        "data":"duration_hours",
                        ...
                        "className":"",
                        "visible": "duration" in dataset[0] ? true : false,
                        "render":function(data,type,row,meta){return row.duration.hours}
                    },
                    {
                        ...
                        "className":"",
                        "visible": "duration" in dataset[0] ? true : false,
                        "render":function(data,type,row,meta){return row.duration.minutes}
                    },
                    {
                        ...
                        "className":"",
                        "visible": "duration" in dataset[0] ? true : false,
                        "render":function(data,type,row,meta){return row.duration.seconds}
                    },
                    {
                        "name":"count_total",
                        "data":"count_total",
