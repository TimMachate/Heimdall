function maintenance_table(api_data_url,model) {
            ...
            success: function(dataset){
                let col = [
                    ...
                    },
                    {
                        ...
                        "defaultContent": "",
                        "className":"",
                        "visible": "last_protocol" in dataset[0] ? true : false,
                        "render":function(data,type,row,meta){
                            if (row.last_protocol){
                                return row.last_protocol.create.datetime_formated
                            } else {
                                return ''
                            }                            
                        }
                    },
                    {
                        ...
                        "defaultContent": "",
                        "className":"",
                        "visible": "next_maintenance" in dataset[0] ? true : false,
                        "render":function(data,type,row,meta){
                            if(row.next_maintenance){
                                return row.next_maintenance.datetime_formated
                            } else {
                                return ''
                            }
