...
class SectionListSerializer(serializers.ModelSerializer):
    ...
    department = DepartmentSerializer(source="department_id",many=False,read_only=True)
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(SectionListSerializer, self).__init__(*args, **kwargs)
...
class SectionDetailSerializer(serializers.ModelSerializer):
    ...
    def __init__(self, *args, **kwargs):
        # Instantiate the superclass normally
        super(SectionDetailSerializer, self).__init__(*args, **kwargs)
        fields = self.context['request'].query_params.get('values')
        if fields:
            fields = fields.split(',')
            # Drop any fields that are not specified in the `fields` argument.
