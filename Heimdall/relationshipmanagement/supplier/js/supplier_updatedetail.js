function supplier_updatedetail(api_data_url,model) {
        ...
        $.ajax({
            ...
            success: function(dataset){
                if(dataset){
                    ...
                    if(dataset.wares){
                        if(dataset.wares.count && document.getElementById("id_wares_count")){
                            document.getElementById("id_wares_count").innerHTML = dataset.wares.count
                        };
                        if(dataset.wares.data){
                            let wares = [
                                {
                                    "name":"id",
                                    "data":"",
                                ...
                                },
                                {
                                    ...
                                    "defaultContent": "",
                                    "className":"",
                                    "visible": "name" in dataset.wares.data[0] ? true : false,
                                    "render":function(data,type,row,meta){
                                        if (row.name){
                                            return row.name
                                        }
                                ...
                                },
                                {
                                    ...
                                    "defaultContent": "",
                                    "className":"",
                                    "visible": "ware_number" in dataset.wares.data[0] ? true : false,
                                    "render":function(data,type,row,meta){
                                        if (row.ware_number){
                                ...
                                },
                                {
                                    ...
                                    "defaultContent": "",
                                    "className":"",
                                    "visible": "unit_package" in dataset.wares.data[0] ? true : false,
                                    "render":function(data,type,row,meta){
                                        if (row.unit_package){
                                ...
                                },
                                {
                                    ...
                                    "defaultContent": "",
                                    "className":"",
                                    "visible": "unit" in dataset.wares.data[0] ? true : false,
                                    "render":function(data,type,row,meta){
                                        if (row.unit){
                                            return row.unit
                                        }
                                ...
                                },
                                {
                                    ...
                                    "defaultContent": "",
                                    "className":"",
                                    "visible": "price" in dataset.wares.data[0] ? true : false,
                                    "render":function(data,type,row,meta){
                                        if (row.price){
                                            return row.price+" €"
                                        }
                                ...
                                },
                                {
                                    ...
                                    "width":"35px",
                                    "className":"",
                                    "visible": "url" in dataset.wares.data[0] ? true : false,
                                    "render":function(data,type,row,meta){
                                        if (row.url){
                                            if (row.url.detail){
                                                detail = '<a class="btn btn-primary" href="'+ row.url.detail +'"><i class="fas fa-search"></i></a>'
                            ...
                            for (let i = 0; i < wares.length; i++){
                                if (wares[i]["visible"] === true) {print.push(i)};
                            };
                            transformTable("id_wares",dataset.wares.data,wares,[[1,'asc']],print);
                        };
                    };
                };
            },
