...
# Model
#--------------------------------------------------------------------------------
class SectionSettings(CreateData,UpdateData):
    user_id = models.OneToOneField(
        name = "user_id",
        verbose_name = "Benutzername",
        related_name = "section_settings_user_id",
        to = get_user_model(),
    ...
    api_url_overview_view = models.TextField(
        ...
        <br>
        Beispiel: <br>
        /api/structuremanagement/section/list/?values=name,reference_number <br>
        Es wird ausschließlich der Name und die Referenznummer angzeigt. <br>
        """,
        default = "/api/structuremanagement/section/list/?values=id,name,url_detail,position_count,section_count,reference_number,employee_count,responsible_name,responsible_url_detail,responsible_telephone,responsible_email,substitute_name,substitute_url_detail,substitute_telephone,substitute_email,image_file_url",
        blank = True,
        null = True,
    )
    ...
    api_url_list_view = models.TextField(
        ...
        Es wird ausschließlich der Name und die Referenznummer angzeigt. <br>
        """,
        default = "/api/structuremanagement/section/list/?values=url_detail,url_update,url_delete,reference_number,name,rgba_value,rgba_style",
        blank = True,
        null = True,
    )
    ...
    api_url_table_view = models.TextField(
        ...
        Es wird ausschließlich der Name und die Referenznummer angzeigt. <br>
        """,
        default = "/api/structuremanagement/section/list/?values=url_detail,reference_number,name,rgba_value,rgba_style,responsible_name,substitute_name,section_count,position_count,employee_count,process_instruction_file_url,update_date,update_time,update_username",
        blank = True,
        null = True,
    )
    ...
    class Meta:
        ...
        ordering = []
        permissions = ()
        verbose_name = "Einstellung für die Abteilung"
        verbose_name_plural = "Einstellungen für die Abteilungen"
#--------------------------------------------------------------------------------