function offer_table(api_url,model) {
        ...
        $.ajax({
            ...
            success: function(dataset){
                if(dataset.length != 0){
                    let col = [
                        ...
                        },
                        {
                            ...
                            "render":function(data,type,row,meta){
                                if(row.authorized){return 'true'}else{return 'false'};
                            }
                        },
                        {
                            "name":"sent",
                            ...
                            "render":function(data,type,row,meta){
                                if(row.sent){return 'true'}else{return 'false'};
                            }
                        },
                        {
                            "name":"sent_date",
                        ...
                        },
                        {
                            ...
                            "render":function(data,type,row,meta){
                                if(row.recived){return 'true'}else{return 'false'};
                            }
                        },
                        {
                            "name":"recived_date",
                        ...
                        },
                        {
                            ...
                            "render":function(data,type,row,meta){if(row.ordered){return 'true'}else{return 'false'};}
                        },
                        {
                            "name":"ordered_date",
                            "data":"ordered_date",
                        ...
                        },
                        {
                            ...
                            "render":function(data,type,row,meta){if (row.notice != 'null'){return 'true'}else{return 'true'};}
                        },
                        {
                            "name":"url_detail",
                            "data":"url_detail",
                            ...
                            "render":function(data,type,row,meta){if (row.url_detail){return row.url_detail};}
                        },
                        {
                            "name":"url_update",
                            "data":"url_update",
                            ...
                            "render":function(data,type,row,meta){if (row.url_update){return row.url_update};}
                        },
                        {
                            "name":"url_delete",
                            "data":"url_delete",
                        ...
                        },
                        {
                            ...
                            "render":function(data,type,row,meta){if (row.url_sent){return row.url_sent};}
                        },
                        {
                            "name":"url_recived",
                            "data":"url_recived",
                            ...
                            "render":function(data,type,row,meta){if (row.url_recived){return row.url_recived};}
                        },
                        {
                            "name":"url_order_true",
                            "data":"url_order_true",
                    ...
                    createTable('id_offer',dataset,col,[[3,'desc'],[4,'desc']],print);
                };
            },
        });
