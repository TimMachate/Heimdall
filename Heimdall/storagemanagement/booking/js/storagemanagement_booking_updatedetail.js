function booking_updatedetail(api_url,model) {
        ...
        $.ajax({
            ...
            success: function(dataset){
                if(dataset){
                    ...
                    if(dataset.stock && document.getElementById("id_stock")){
                        document.getElementById("id_stock").setAttribute('value',dataset.stock);
                    };
