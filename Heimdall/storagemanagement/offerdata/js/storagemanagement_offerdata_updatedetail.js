function offerdata_updatedetail(api_url,model) {
        ...
        $.ajax({
            ...
            success: function(dataset){
                if(dataset){
                    ...
                    // Offer
                    if(dataset.offer_reference_number && document.getElementById('id_offer_reference_number')){
                        document.getElementById('id_offer_reference_number').setAttribute('value',dataset.offer_reference_number);
                    };
                    if(dataset.offer_url_detail && document.getElementById('id_offer_url_detail')){
                        document.getElementById('id_offer_url_detail').setAttribute('href',dataset.offer_url_detail);
                    };
                    // Amount
