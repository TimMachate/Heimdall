function offerdata_overview(api_url,model) {
                ...
                if(dataset.length != 0){
                    let col = [
                        ...
                        },
                        {
                            ...
                            "render":function(data,type,row,meta){if(row.notice){return row.notice};}
                        },
                        {
                            "name":"url_detail",
                            "data":"url_detail",
                    ...
                    createList('id_offerdata',dataset,col,[[1,'desc'],[2,'desc']],print);
                };
            },
        });
